...
;;;###autoload
  ...
  (define-key anything-c-buffer-map "\M-e" 'anything-execute-persistent-action)
  (define-key anything-c-buffer-map "\M-h" 'paredit-backward-delete)
  (define-key anything-c-buffer-map "\M-H" 'paredit-backward-delete)
  (define-key anything-c-buffer-map "\M-n" 'anything-next-line)
  (define-key anything-c-buffer-map "\C-n" 'next-history-element)
  (define-key anything-c-buffer-map "\M-o" 'anything-buffer-or-ff-run-switch-other-window)
  (define-key anything-c-buffer-map "\M-p" 'anything-previous-line)
  (define-key anything-c-buffer-map "\C-p" 'previous-history-element)
  ...
  (define-key anything-c-buffer-map "\M-w" 'paredit-backward-kill-word)

  (define-key anything-generic-files-map "\M-n" 'anything-next-line)
  (define-key anything-generic-files-map "\C-n" 'next-history-element)
...
(defun my-evil-map-setup ()
  ...
  (evil-rmap "\M-x" 'anything-execute-extended-command)
