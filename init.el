...
(define-key my-tab-map "e"    'vim:cmd-tab-new)
(define-key my-tab-map "c"    'vim:cmd-tab-close)
...
(define-key my-tab-map "\M-e" 'vim:cmd-tab-new)
(define-key my-tab-map "\M-c" 'vim:cmd-tab-close)
...
(defun my-c-mode-hook ()
  (vim:local-nmap "\M-B" 'gud-break)
  (vim:local-nmap "\M-C" 'gud-cont)
  (vim:local-nmap "\M-D" 'gud-down)
  (vim:local-nmap "\M-F" 'gud-finish)
  (vim:local-nmap "\M-I" 'gud-interrupt)
  (vim:local-nmap "\M-K" 'gud-kill-yes)
  (vim:local-nmap "\M-M" 'gud-restart)
  (vim:local-nmap "\M-N" 'gud-next)
  (vim:local-nmap "\M-P" 'gud-print)
  (vim:local-nmap "\M-R" 'gud-remove)
  (vim:local-nmap "\M-S" 'gud-step)
  (vim:local-nmap "\M-T" 'gud-tbreak)
  (vim:local-nmap "\M-u" 'gud-until)
