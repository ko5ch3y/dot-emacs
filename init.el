...
;;;###autoload
  ...
  (define-key anything-map "\M-z" 'universal-argument)
  ...
  (define-key anything-c-buffer-map "\M-z" 'universal-argument)

  (define-key anything-kill-ring-map "\M-e" 'anything-execute-persistent-action)
  (define-key anything-kill-ring-map "\M-n" 'anything-next-line)
  (define-key anything-kill-ring-map "\M-p" 'anything-previous-line)
  (define-key anything-kill-ring-map "\C-n" 'next-history-element)
  (define-key anything-kill-ring-map "\C-p" 'previous-history-element)
  (define-key anything-kill-ring-map "\M-h" 'paredit-backward-delete)
  (define-key anything-kill-ring-map "\M-H" 'paredit-backward-delete)
  (define-key anything-kill-ring-map "\M-w" 'paredit-backward-kill-word)
  (define-key anything-kill-ring-map "\M-z" 'universal-argument)
  ...
  (define-key anything-generic-files-map "\M-h" 'paredit-backward-delete)
  (define-key anything-generic-files-map "\M-H" 'paredit-backward-delete)
  (define-key anything-generic-files-map "\M-w" 'paredit-backward-kill-word)
