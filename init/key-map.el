...
(defun my-evil-map-setup ()
  ...
  (evil-nmap "\M--" 'comment-dwim)
  (evil-vmap "\M--" 'comment-dwim)
  (evil-imap "\M--" 'comment-dwim)
  (evil-nmap "_"    'paredit-comment-dwim)
  (evil-nmap "\M- "   'ace-jump-word-mode)
  (evil-vmap "\M- "   'ace-jump-word-mode)
  (evil-imap "\M- "   'ace-jump-word-mode)
  (evil-nmap (kbd "<C-M- >") 'ace-jump-mode-pop-mark)
  (evil-vmap (kbd "<C-M- >") 'ace-jump-mode-pop-mark)
  (evil-imap (kbd "<C-M- >") 'ace-jump-mode-pop-mark)
