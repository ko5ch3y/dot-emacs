...
(defun color-theme-bright-is-right ()
  "Color theme based on the bright-is-right kuler color scheme."
  (interactive)
  (color-theme-install
   '(color-theme-bright-is-right
...
(provide 'color-theme-bright-is-right)
