...
(defun color-theme-lolokai ()
  ...
  (color-theme-install
   '(color-theme-lolokai
     ...
     (mode-line ((t (:foreground "#000000" :background "#A6E22A"
                                 :box (:line-width 1 :style released-button)))))
     ;(mode-line-buffer-id ((t (:foreground nil :background "#CD5907" :weight semi-bold))))
     (mode-line-inactive ((t (:foreground "#000000" :background "#BEB7B4"
                                          :box (:line-width 1 :color "#232526")))))
     (mode-line-mousable ((t (:foreground "#000000" :background "#BEB7B4"))))
     (mode-line-mousable-minor-mode ((t (:foreground "#BCBCBC" :background "#BEB7B4"))))
     (font-lock-builtin-face ((t (:foreground "#A6E22E"))))
     (font-lock-comment-face ((t (:foreground "#B2BEB5"))))
     (font-lock-comment-delimiter-face ((t (:foreground "#B2BEB5"))))
     (font-lock-constant-face ((t (:foreground "#228B22"))))
     ...
     (markdown-comment-face ((t (:foreground "#B2BEB5"))))
