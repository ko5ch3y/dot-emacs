...
(defun color-theme-molokai ()
  ...
  (color-theme-install
   '(color-theme-molokai
     ...
     (mode-line ((t (:foreground "#F8F8F2" :background "#CD5907"
     ...
     (font-lock-function-name-face ((t (:foreground "#CD5907" :slant italic))))
     (font-lock-keyword-face ((t (:foreground "#66D9EF"))))
     (font-lock-negation-char-face ((t (:weight bold))))
     (font-lock-preprocessor-face ((t (:foreground "#CD5907"))))
     ...
     (show-paren-match-face ((t (:foreground "#F92672" :background "#1B1D1E"))))
