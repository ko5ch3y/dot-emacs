...
(defvar solarized-colors           ; ANSI(Solarized terminal)
  ...
  '((base03  "#262626" "#042028" "#1c1c1c" "brightblack"   "black")
    (base02  "#303030" "#0a2832" "#262626" "black"         "black")
      ...
      (let ((back base03))
        ...
        (let ((bg-back   `(:background ,back))
          ...
          `((;; basic
             ...
             (region ((t (,@fg-base03 :background "#8B2323" ,@fmt-none)))) ; Visual
             ...
             (show-paren-match ((t (,@fmt-bold ,@fg-blue :background nil))))
             (show-paren-mismatch ((t (,@fmt-bold ,@fg-red :background nil))))
             ;; widgets
             (widget-field
             ...
             (helm-selection ((t (,@fg-base03 :background "#8B2323" ,@fmt-none))))
             (helm-selection-line ((t (,@fg-base03 :background "#8B2323" ,@fmt-none))))
